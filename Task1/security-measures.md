...
graph LR
    ...
    Employe --> |Создание медицинской карты с именем и отчеством, хроническими заболеваниями| DB
...
graph LR
    ...
    Employe --> |Счет для оплаты| DB
    DB --> |Медицинская карта с именем и отчеством, без дополнительной информации| Employe
    DB --> |Счет для оплаты| Employe1
